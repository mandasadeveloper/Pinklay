    ...
    var l = document.querySelector(".template-product")
      ...
      , h = function t() {
        ...
        u(this, "adjustSizeTableWidth", (function() {
            ...
            $('.table-inner-row:not(".row-0")').css("width", t),
            $('.radio-boxes p:not(".empty-cell")').css("width", t);
        ...
        u(this, "pdpSizePopup", (function() {
            ...
            $(".first-table-wrap .content[data-value]").each((function(e, n) {
                ...
                i += " soldout"),
                t += "<p>" + '<input type="radio" data-index="'+$(this).data("index")+'" name="size option" id="'.concat($(this).data("value"), '" value="').concat($(this).data("value"), '" class="').concat(i, '">') + '<label for="'.concat($(this).data("value"), '" class="size-btn"></label>') + "</p>"
            }
            )),
            ...
            $(".first-table-wrap input").change((function() {
                ...
                if (e.length > 0) {
                 ...
                 var btn_html = $(".product-shop .groups-btn div:first-child").html();
                   ...
                   e.find('.size-guide-button .btn-div').html(btn_html.attr('id',''));
