      ...
      , h = function t() {
        ...
        u(this, "pdpSizePopup", (function() {
            ...
            $(".first-table-wrap .content[data-value]").each((function(e, n) {
                ...
                i += " soldout"),
                t += "<p>" + '<input type="radio" name="size option" id="'.concat($(this).data("value"), '" value="').concat($(this).data("value"), '" class="').concat(i, '">') + '<label for="'.concat($(this).data("value"), '" class="size-btn"></label>') + "</p>"
            }
            )),
        ...
        u(this, "sizeCartOnInput", (function() {
            $(".first-table-wrap input").change((function() {
                ...
                if (e.length > 0) {
                    var n = this.value;
                    $(".ProductForm .SizeSwatchList input[type=radio][value='" + n + "']").click();
